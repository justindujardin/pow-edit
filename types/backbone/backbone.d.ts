...
/*
    Pow2 - reference pow-core library that includes underscore module typedefs.
        Typescript does not handle having two libraries reference different
        underscore.d.ts files well.
*/
