...
declare module AceAjax {
    ...
    export interface EventEmitter {
        removeEventListener(event: string, fn: (e) => any);
        removeListener(event: string, fn: (e) => any);
        off(event: string, fn: (e) => any);

        addEventListener(event: string, fn: (e) => any,capturing?:boolean);
        addListener(event: string, fn: (e) => any,capturing?:boolean);
        on(event: string, fn: (e) => any,capturing?:boolean);
    }
